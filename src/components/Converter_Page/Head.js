                        ...
                        <div className=' cursor-pointer w-full'>
                            <label htmlFor="choose-file" className='cursor-pointer'>
                                ...
                                <div className='relative rounded-lg w-full h-full'>
                                    <div className='z-30 absolute inset-[10px] border border-dashed border-white rounded'></div>
                                    <div className='h-full w-full flex flex-col items-center justify-center'>
                                        ...
                                        <div className='cursor-pointer'>
                                            <div className='flex mt-4 bg-white rounded overflow-hidden'>
                                                <div className='z-50 flex items-center font-bold p-4 hover:bg-gray-200 '>
                                                ...
                                                <button
                                                    className="z-50 p-4 border-l-2 hover:bg-gray-200"
                                                    onClick={(evt) => {
