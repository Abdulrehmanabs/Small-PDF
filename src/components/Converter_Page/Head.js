                                        ...
                                        <div className='cursor-pointer'>
                                            <div className='rounded mt-4 bg-white'>
                                                <div className=' flex items-center bg-transparent font-bold p-4 '>
                                                    ...
                                                    <span className='ml-2 whitespace-nowrap font-bold uppercase bg-transparent'>
                                                        Choose Files
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
                                        <div className='pt-3 pr-3 pl-2 text-center text-white'>
                                            Or drop files here
                                        </div>
                                    </div>
                                </div>
